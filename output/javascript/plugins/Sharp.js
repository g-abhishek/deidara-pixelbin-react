...
export const resize = function({
    height = 0,width = 0,fit = 'cover',background = '000000',position = 'center'
}) {
    return new Transformation([`t.resize(h:${ height },w:${ width },f:${ fit },b:${ background },p:${ position })`]);
}
...
export const extend = function({
    top = 10,left = 10,bottom = 10,right = 10,background = '000000'
}) {
    return new Transformation([`t.extend(t:${ top },l:${ left },b:${ bottom },r:${ right },bc:${ background })`]);
}
...
export const extract = function({
    top = 10,left = 10,height = 50,width = 20
}) {
...
export const png = function({
    quality = 90,progressive = false,compressionLevel = 9
}) {
