import { getTransformationsFromUrl, getUrlTransformationString, getImageUrlWithOptions } from "./transformation.utils";
...
class UrlUtils {
    ...
    generatePixelbinUrl(imageUrl, transformationList, version="v2") {
        return getImageUrlWithOptions(imageUrl, this.generatePixelbinPattern(transformationList, this.pixelbin.config), version);
    } 
}
